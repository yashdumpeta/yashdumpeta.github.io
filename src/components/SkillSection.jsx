      ...
      <div id="skill-container">
        ...
        <div id='tools_section'>
          ...
          <div id='tools-items'>
            ...
            <div className="skill-item">
              <SiRedhatopenshift /> <span className='skill-name'>Redhat Openshift</span>
            </div>
            <div className="skill-item">
